...
async function getNotesPageInfo(syncTag) {
    try {
        ...
        const url = (syncTag !== null)
            ? 'https://us.i.mi.com/note/full/page?ts=' + ts + '&syncTag=' + syncTag + '&limit=200'
            : 'https://us.i.mi.com/note/full/page?ts=' + ts + '&limit=200';
...
async function parse() {
    ...
    const result = {
        ...
        notes: notes,
        folders: notesDirectoryInfo.folders,
    };
