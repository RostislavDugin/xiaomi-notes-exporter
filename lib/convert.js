if (!("xmlToMarkdownConverter" in window)) {
    (() => {

        const xmlToMarkdownConverter = {
            xmlToMarkdown: null
        };

        window.xmlToMarkdownConverter = xmlToMarkdownConverter;
        ...
        xmlToMarkdownConverter.xmlToMarkdown = _xmlToMarkdown;
    })();
}
